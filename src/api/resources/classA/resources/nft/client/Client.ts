    ...
    public async getTokenIds(
        ...
        const _response = await core.fetcher({
            url: urlJoin(
                ...
                `/v1/${chainId}/tokens/${contractAddress}/nft_token_ids/`
            ),
            method: "GET",
            headers: {
        ...
        if (_response.ok) {
            return await serializers.classA.nft.getTokenIds.Response.parse(
                _response.body as serializers.classA.nft.getTokenIds.Response.Raw
            );
        }
